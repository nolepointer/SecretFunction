...
public class AdditiveFunctionTesterDriver {
    ...
    /**
     * Main class to be called from a command line. Given an argument
     * representing the limit on the value of prime numbers to test
     * with the secret function
     * 
     * @param args
     */
	...
	if (AdditiveFunctionTester.isSecretAdditive(primes))
